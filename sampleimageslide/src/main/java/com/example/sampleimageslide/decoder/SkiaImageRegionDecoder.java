package com.example.sampleimageslide.decoder;
...
/**
 * this works well in most circumstances and has reasonable performance due to the cached decoder instance,
...
public class SkiaImageRegionDecoder {
    ...
    public SkiaImageRegionDecoder(@Nullable Bitmap.Config bitmapConfig) {
        Bitmap.Config globalBitmapConfig = SimpleScaleImageView.getPreferredBitmapConfig();
