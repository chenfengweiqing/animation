...
import static com.chenfengweiqing.animationview.UIUtils.getResources;
...
public class RotateClockView extends View {
    ...
    public RotateClockView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
